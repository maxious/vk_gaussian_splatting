...
from model.utils.normalize import intersect_skew_lines_high_dim
...
def rq(M):
    # https://stackoverflow.com/questions/76735175/how-do-i-compute-rq-facorization-using-qr-python-library
