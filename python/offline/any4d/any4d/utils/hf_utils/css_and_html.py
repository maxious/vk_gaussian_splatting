...
def get_description_html():
    ...
    <p>This demo demonstrates the image input configuration only. For trying out additional inputs like cameras and depth, please check out the code in our <a href="https://github.com/facebookresearch/map-anything">Github repo</a>.</p>
